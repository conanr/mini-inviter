...
describe EventsHelper do
  describe "display_restaurant_names" do
    ...
    context "when an event has restaurant options" do
      ...
      let!(:restaurant_option_1)  { RestaurantOption.create event_id: event.id, restaurant_id: restaurant_1.id }
      let!(:restaurant_option_2)  { RestaurantOption.create event_id: event.id, restaurant_id: restaurant_2.id }
